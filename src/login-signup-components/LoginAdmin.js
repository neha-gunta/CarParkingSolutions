...
function LoginAdmin(props: MyComponent){
    ...
    return (  
        <div className="container"><br />
                <div className="row">
                    ...
                    <h3 className="text-center mt-4">Login as Admin</h3>
                        <div className="card-body">
                            <form>
                                ...
                                <div className="text-center">
                                    <button className="btn btn-success" onClick={LoginAsAdmin}>Login</button>
                                </div><br />
